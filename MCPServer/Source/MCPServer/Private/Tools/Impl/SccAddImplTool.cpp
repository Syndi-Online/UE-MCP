...
FSccAddImplTool::FSccAddImplTool(ISCCModule& InSCCModule)
	: SCCModule(InSCCModule)
{
}

FString FSccAddImplTool::GetName() const
{
	return TEXT("scc_add");
}

FString FSccAddImplTool::GetDescription() const
{
	return TEXT("Add files to source control");
}

TSharedPtr<FJsonObject> FSccAddImplTool::GetInputSchema() const
{
...
TSharedPtr<FJsonObject> FSccAddImplTool::Execute(const TSharedPtr<FJsonObject>& Arguments)
{
	...
	FSCCOperationResult OpResult = SCCModule.Add(Files);
